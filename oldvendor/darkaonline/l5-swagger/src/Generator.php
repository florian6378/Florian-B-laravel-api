...
class Generator
{
    ...
    public function __construct(
        ...
        $this->annotationsDir = Arr::get($paths, 'annotations.0', null);
        $this->docDir = Arr::get($paths, 'docs', null);
        ...
        $this->excludedDirs = Arr::get($paths, 'excludes', []);
        $this->basePath = $paths['base'] ?? null;
    ...
    protected function prepareDirectory(): self
    {
        ...
        if (! $this->fileSystem->exists($this->docDir)) {
            throw new L5SwaggerException('Documentation storage directory could be created');
        }
